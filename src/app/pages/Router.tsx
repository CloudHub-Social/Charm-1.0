    ...
    <Route>
      ...
      >
        <Route
          ...
          loader={async () => {
            if (hasStoredSession()) {
              // Awaited here (rather than a fire-and-forget redirect
              // elsewhere racing this loader's own default-landing
              // redirect) so recovery is deterministic: a data-router
              // loader is fully resolved before anything renders or
              // navigates, regardless of how fast/slow Cache Storage
              // happens to be on a given browser engine.
              ...
              if (recovered) {
                ...
                return redirect(recovered.path);
              }
