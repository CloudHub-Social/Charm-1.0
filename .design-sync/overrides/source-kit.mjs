// forked from design-sync lib/source-kit.mjs — repoints ./dts.mjs to the local forked dts.mjs (folds ships .d.ts in dist/ without a `types` field); sibling common/bundle imports point back at the staged lib
